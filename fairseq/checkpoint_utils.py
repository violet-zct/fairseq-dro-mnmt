...
def load_checkpoint(args, trainer, **passthrough_args):
    ...
    *passthrough_args* will be passed through to
    ...
    if extra_state is not None and not reset_dataloader:
        ...
        if hasattr(args, 'competent_cl') and args.competent_cl and itr_state["epoch"] > args.warmup_epochs:
            set_data_prop = True
        elif hasattr(args, 'burnout_epochs') and args.burnout_epochs > 0 and itr_state["epoch"] > args.burnout_epochs and args.compute_train_dynamics:
            set_data_prop = True
