...
exp_name=17_outer_ub_hier_ema0.05_alpha0.5_beta0.5_wu_opus_${ename}
...
python train.py ${DATA}\
    ...
    --dro-outer-alpha 0.5 --dro-inner-beta 0.5 --update-dro-freq 1000 --outer-group-level ${glevel} --ema 0.05 \
