...
exp_name=88_decay_steps_${decay_steps}_rho_${decay_end}_sent_baseline_chi_square_batch_wmt4_de_${ename}
...
python train.py ${DATA}\
    ...
    --sent-baseline-path ${DATA}/train_sents_o2m.loss \
    --rho-decay-steps ${decay_steps} --rho-decay-end ${decay_end} \
    --rho ${rho} --group-level ${glevel} \
