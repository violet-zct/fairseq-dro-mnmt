...
if [ $SLURM_ARRAY_TASK_ID = 0 ]; then
    lang_pairs="en-oc,en-be,en-ta,en-ka,en-gl,en-hi,en-bg,en-is"
    ename="o2m"
    gtgt="xx"
    etok="tgt"
    glevel="target_lang"
    ...
    lang_pairs="oc-en,be-en,ta-en,ka-en,gl-en,hi-en,bg-en,is-en"
    ename="m2o"
    gtgt="en"
    etok="src"
    glevel="source_lang"
...
exp_name=54_ema_0.01_ch_0_rho_0.05_min_0.2_chi_square_resample_opus8_${ename}
...
python train.py ${DATA}\
    ...
    --rho 0.05 --min-prob 0.2 --group-level ${glevel} --ema 0.01 --clear-history 0 \
