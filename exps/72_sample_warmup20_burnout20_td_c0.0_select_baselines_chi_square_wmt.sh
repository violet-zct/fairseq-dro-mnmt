...
exp_name=72_sample_warmup20_burnout20_td_select_c0.05_baselines_ema_0.1_ch_0_rho_${rho}_min_0.2_chi_square_resample_wmt4_de_${ename}
...
python train.py ${DATA}\
    --warmup-epochs 20 --burnout-epochs 20 --selection-method sample \
