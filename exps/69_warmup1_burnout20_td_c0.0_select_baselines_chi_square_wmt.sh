...
exp_name=69_warmup1_burnout20_td_select_c0.0_baselines_ema_0.1_ch_0_rho_${rho}_min_0.2_chi_square_resample_wmt4_de_${ename}
...
python train.py ${DATA}\
    --warmup-epochs 1 --burnout-epochs 20 --exclude-c 0.0 --max-scale-up 1.0 --compute-train-dynamics 1 \
