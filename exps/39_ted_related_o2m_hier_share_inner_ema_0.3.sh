...
exp_name=39_ema_0.3_share_inner_step_warmup_50k_hier_dro_ted8_related_o2m
...
python train.py ${DATA}\
    --start-ft-steps 50000 \
	  ...
	  --criterion 'hier_dro_share_inner_label_smoothed_cross_entropy' --label-smoothing 0.1 \
	  --dro-outer-alpha 0.5 --dro-inner-beta 0.5 \
	  --update-dro-freq 1000 --outer-group-level "target_lang" --ema 0.3 \
