...
#SBATCH --job-name=59.related.o2m
#SBATCH --nodes=1
...
exp_name=59_sanity_beta1.0_ub_step_lr_warmup_50k_hier_dro_ted8_related_o2m
...
python train.py ${DATA} \
    --start-ft-steps 25000 \
	  ...
	  --encoder-langtok "tgt" --enable-lang-ids --log-path ${SAVE}/inner_log.txt \
	  --criterion 'upper_bound_hier_dro_label_smoothed_cross_entropy' --label-smoothing 0.1 \
	  --dro-outer-alpha 0.5 --dro-inner-beta 1.0 \
	  --update-dro-freq 1000 --outer-group-level "target_lang"\
