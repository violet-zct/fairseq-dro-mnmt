...
#SBATCH --job-name=28.lang.dro.e0.1.a0.2.nowu
#SBATCH --nodes=1
...
exp_name=28_ema0.1_alpha0.2_nowu_ub_step_lr_lang_dro_ted8_${ename}
...
python train.py ${DATA}\
    --start-ft-steps 0 \
	  ...
	  --dro-alpha 0.2 --update-dro-freq 1 --group-level ${glevel} --ema 0.1 \
