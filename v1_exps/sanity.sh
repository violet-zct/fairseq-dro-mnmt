...
#SBATCH --job-name=sanity.nlang.dro.e0.1.a0.5.wu
#SBATCH --nodes=1
...
exp_name=108_sanity_wu_step_lr_lang_dro_ted8_${ename}
...
python train.py ${DATA}\
    --start-ft-steps 25000 \
	  ...
	  --criterion 'sanity_plain_dro_label_smoothed_cross_entropy' --label-smoothing 0.1 \
