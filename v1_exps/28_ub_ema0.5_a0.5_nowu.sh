...
#SBATCH --job-name=28.lang.dro.e0.5.a0.5.nowu
#SBATCH --nodes=1
...
exp_name=28_ema0.5_alpha0.5_nowu_ub_step_lr_lang_dro_ted8_${ename}
...
python train.py ${DATA}\
    --start-ft-steps 0 \
	  ...
	  --dro-alpha 0.5 --update-dro-freq 1 --group-level ${glevel} --ema 0.5 \
