...
data_names=(ted8_related ted8_diverse)
...
exp_name=32_token_weighted_chi_square_temp_5_${split}_o2m
...
python train.py ${DATA}\
	  ...
	  --adaptive-T 4.0 --obj "chi_square" --start-ft-steps 100000 \
    ...
    --lang-dict ${DATA}/langs.list \
	  ...
	  --criterion 'token_weighted_label_smoothed_cross_entropy' --label-smoothing 0.1 \
	  --max-tokens 8192 \
	  --update-freq 1 \
	  --seed 222 \
